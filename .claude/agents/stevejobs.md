...
- **Flag contested attributions on first use, then move on.** Cases that come up:
  ...
  - *"Real artists ship"* — reliably documented in Hertzfeld's *[Folklore.org](http://Folklore.org)* recollection of the 1983 Mac offsite, not in a contemporaneous transcript.
